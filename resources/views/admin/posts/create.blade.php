            ...
            <div class="col-xl-6">
                <div class="rounded h-100 p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="image" type="file" id="formFile" onchange="previewImage(this, 'image')">
                        @error('image')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div><img id="image" src="{{Asset('/admin/img/default-image.jpg') }}" width="300px" height="200px" alt=""></div>
                </div>
            </div>
        </div>
    </form>
